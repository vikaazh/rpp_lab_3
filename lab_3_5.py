...
conn = http.client.HTTPConnection("167.172.172.227:8000")
conn.request('GET', '/number/?option=5')
r1 = conn.getresponse()
print(r1.status, r1.reason)
...
conn.request('POST', '/number/', 'option=5', headers)
r1 = conn.getresponse()
print(r1.status, r1.reason)
...
conn.request('PUT', '/number/', json.dumps({'option': 5}), headers)
r1 = conn.getresponse()
...
conn = http.client.HTTPConnection("167.172.172.227:8000")
conn.request('DELETE', '/number/', json.dumps({'option': 5}))
r1 = conn.getresponse()
print(r1.status, r1.reason)
